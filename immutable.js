...
newPerson.name = 'The Green Goblin';
newPerson.age = 55;
...
*/
const superHeroes = ['Batman', 'Black Panther', 'The Incredible Hulk', 'Wonder Woman', 'Captain America', 'Iron Man', 'Storm'];
const superVillains = ['Catwoman', 'Killmonger', 'Maestro', 'Doctor Cyber', 'Baron Zemo', 'Mandarin', 'Deluge'];
