...
*/
const superHeroes = ['Batman', 'Superman', 'Wonderwoman', 'Green Lantern', 'The Flash'];
const superVillains = ['The Joker', 'Lex Luthor', 'Ares', 'Sinestro', 'Reverse Flash'];
