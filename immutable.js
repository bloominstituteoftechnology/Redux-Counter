...
newPerson = Object.assign({}, person, {name: 'Charles', age: '18'});
...
*/
let superHeroes = ['Spiderman', 'Spawn', 'Silver Surfer', 'Sabel' ];
let superVillains = ['Morbeous', 'Carnage', 'Galactus', 'Phoenix'];
