...
*/
const person = {name: 'Sarah', age: 25, hometown: 'New York'};
const newPerson = Object.assign({}, {name: 'Samantha'}, {age: 27}, {hometown: person.hometown});
console.log(person);
...
const superHeroes = ['Superman', 'Thor', 'Batman', 'Hulk'];
const superVillains = ['Magneto', 'Joker', 'Doctor Doom'];
...
const studentScores = {name: 'Laura', age: 30, scores: [10, 34, 45, 32, 35, 1, 50]}
const studentAverage = Object.assign({}, {scores: studentScores.scores.filter(score => score >= 34)});
