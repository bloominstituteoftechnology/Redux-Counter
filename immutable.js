...
const superHeroes = ['Superman','Batman','hyperman'];
const superVillains = ['Cruella', 'Joker', 'Darth Vader'];
...
studentAverage.scores = Object.assign(studentScores.scores.filter(word => word > 34));
