...
const person = {name: 'Robert', age: 30, hometown: 'Hayward'};
const newPerson = Object.assign({}, person, {name: 'Megan', age: 29});
...
const superHeroes = ['Thor', 'Ironman', 'Groot'];
const superVillains = ['Hella', 'Ultron', 'Thanos'];
...
const studentScores = { name: 'Serenity', age: 16, scores: [1, 25, 50]};
