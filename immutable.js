...
let person = { name: Punit, age: 44, hometown: 'Los Angeles' };
// let newPerson = Object.assign({}, person)
// newPerson.name = 'Jon';
// newPerson.age = 37;
let newPerson = {...person, name: 'Jon', age: 37};
...
const superVillains = ["Lexus Luthor", "Poker", "Wokegirl"];
...
const studentScores = { name: 'Jon', age: 37, scores: [2, 4, 16, 18, 20, 44, 48, 49]};
const studentAverage = Object.assign({}, studentScores);
studentAverage.scores = studentAverage.scores.filter(val => {
  return val > 34;
});
