...
*/
let superHeroes = [
  'Superman', 'Batman', 'The Green Lantern',
]
let superVillains = [
  'Dr.Evil', 'The Joker', 'The Green Goblin',
]
...
let studentScores = {
  name: 'Igor',
  age: 23,
  scores: [33, 11, 66, 88, 99, 100],
}
let studentAverage = Object.assign({}, studentScores)
studentAverage.scores = studentScores.scores.filter((score) => { return score >= 34 })
