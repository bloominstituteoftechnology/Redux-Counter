...
const newPerson = Object.assign({}, person, { name: 'Carol', age: '46' });
console.log(person);
...
*/
const superHeroes = ['Dr. Strange', 'Black Panther', 'Iron Man', 'Thor', 'Black Widow', 'Hulk', 'Spiderman'];
const superVillains = ['Thanos', 'Ultron', 'Hydra', 'Adam Warlock', 'Ego', 'Death'];
...
studentScores = {
  name: 'Daniel',
  age: 26,
  scores: [33, 44, 35, 45, 50, 30]
}

studentAverage = Object.assign({}, studentScores, { scores: studentScores.scores.filter(i => i >= 34)} );
