...
const superHeroes = ["Spider-man", "Wolverine", "Batman"];
const superVillains = ["Venom", "Magneto", "Mr. Freeze"];
...
const studentAverage = Object.assign({}, studentScores.scores.filter(nums => nums > 34));
