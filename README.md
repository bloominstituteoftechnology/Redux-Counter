...
In this Project, you'll first get some practice with objects and arrays in an `immutable` context. Then you'll be eased into the code base of a small Redux application. The application itself is just a counter with increment and decrement buttons.
