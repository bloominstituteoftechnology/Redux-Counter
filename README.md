...
* To run the project code, use the command `yarn upgrade` from the root directory to install your `node_modules`. Then `yarn start`. You'll see that the application isn't working.
